...
function Info() {
  return (
    <div
      ...
      className="w-full h-[140vh] font-NeueMontreal text-[#252B48]  rounded-t-3xl bg-[#75C2F6]"
    >
      <div className="w-[80%] leading-[3.4vw] tracking-tight rounded-t-3xl text-[3.5vw] py-32 px-20">
        <h1>
      ...
      <div className="w-full px-20 py-16">
        ...
        <div className="flex justify-around px-40 py-12 items-center">
          {/* <div className=""> */}
            <img src="https://dm6g3jbka53hp.cloudfront.net/static-images/adopt-me-pet-02032021.jpg" width={400} alt="" />
